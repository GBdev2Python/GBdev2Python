...
class VacancyFilter(django_filters.FilterSet):
    ...
    employment_id = django_filters.ModelMultipleChoiceFilter(queryset=TypeEmployment.objects.all(), widget=forms.CheckboxSelectMultiple)
    skills_id = django_filters.ModelMultipleChoiceFilter(queryset=Skill.objects.all(), widget=forms.CheckboxSelectMultiple)
