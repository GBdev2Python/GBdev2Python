...
urlpatterns = [
    ...
    path('employer_list/', EmployerList.as_view(), name="employer_list"),  # http://127.0.0.1:8000/employer_list/
    ...
    path('vacancy_list/', AllVacancyList.as_view(), name="vacancy_list"),  # http://127.0.0.1:8000/vacancy_list/
